...
{
    /// <summary>
    /// Serializes a <paramref name="payload"/> using the configured Newtonsoft.Json settings.
    /// </summary>
    ...
    /// <summary>
    /// Deserializes a JSON <paramref name="payload"/> using the configured Newtonsoft.Json settings.
    /// </summary>
