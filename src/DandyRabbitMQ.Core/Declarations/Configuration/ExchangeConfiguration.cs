...
/// <summary>Configures a RabbitMQ exchange declaration.</summary>
public sealed class ExchangeConfiguration(string name)
{
    ...
    /// <summary>Gets or sets a value indicating whether the exchange is deleted automatically.</summary>
