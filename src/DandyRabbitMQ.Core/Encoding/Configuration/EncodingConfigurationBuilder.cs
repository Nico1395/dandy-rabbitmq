...
/// <summary>Builds payload encoding configuration.</summary>
public sealed class EncodingConfigurationBuilder
{
    private readonly EncodingConfiguration _configuration = new();

    /// <summary>Selects the payload encoder implementation.</summary>
    ...
    /// <summary>Builds the encoding configuration.</summary>
