...
/// <summary>Provides dependency injection registration extensions for payload encoding.</summary>
public static class EncodingServiceCollectionExtensions
{
    /// <summary>Adds and configures a payload encoder.</summary>
    ...
    /// <summary>Adds a payload encoder from an existing configuration.</summary>
    /// <param name="services">The service collection to update.</param>
