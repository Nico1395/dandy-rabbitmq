...
/// <summary>Encodes payloads using big-endian UTF-16.</summary>
public class BigEndianUnicodePayloadEncoder : IPayloadEncoder
{
    /// <summary>Encodes a string as big-endian UTF-16 bytes.</summary>
    ...
    /// <summary>Decodes big-endian UTF-16 bytes into a string.</summary>
