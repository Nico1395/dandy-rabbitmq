...
/// <summary>Encodes payloads using ISO-8859-1.</summary>
public class Latin1PayloadEncoder : IPayloadEncoder
{
    /// <summary>Encodes a string as ISO-8859-1 bytes.</summary>
    ...
    /// <summary>Decodes ISO-8859-1 bytes into a string.</summary>
