...
/// <summary>Contains message metadata and message discovery settings.</summary>
public sealed class MessagesConfiguration
{
    /// <summary>Gets or sets message metadata indexed by runtime type.</summary>
    public required ConcurrentDictionary<Type, MessageConfiguration> MessagesByRuntimeType { get; set; }
    /// <summary>Gets or sets message metadata indexed by message key.</summary>
    public required ConcurrentDictionary<string, MessageConfiguration> MessagesByKey { get; set; }
    /// <summary>Gets or sets assemblies scanned for attributed message types.</summary>
    public required Assembly[] Assemblies { get; set; }

    /// <summary>Merges two message configurations.</summary>
    ...
    /// <summary>Adds a message configuration indexed by runtime type.</summary>
